...
$modversion['templates'][29]['description'] = 'The embedded template for the color of the xoopsform.';
$modversion['templates'][30]['file'] = 'legacy_xoopsform_button.html';
$modversion['templates'][30]['description'] = 'The embedded template for the button of the xoopsform.';
$modversion['templates'][31]['file'] = 'legacy_xoopsform_text.html';
$modversion['templates'][31]['description'] = 'The embedded template for the text of the xoopsform.';
$modversion['templates'][32]['file'] = 'legacy_xoopsform_select.html';
$modversion['templates'][32]['description'] = 'The embedded template for the select of the xoopsform.';
$modversion['templates'][33]['file'] = 'legacy_xoopsform_file.html';
$modversion['templates'][33]['description'] = 'The embedded template for the file of the xoopsform.';
...
$modversion['templates'][35]['description'] = 'The embedded template for the hidden of the xoopsform.';
$modversion['templates'][36]['file'] = 'legacy_xoopsform_label.html';
$modversion['templates'][36]['description'] = 'The embedded template for the label of the xoopsform.';
$modversion['templates'][37]['file'] = 'legacy_xoopsform_password.html';
$modversion['templates'][37]['description'] = 'The embedded template for the password of the xoopsform.';
$modversion['templates'][38]['file'] = 'legacy_xoopsform_textarea.html';
$modversion['templates'][38]['description'] = 'The embedded template for the textarea of the xoopsform.';
$modversion['templates'][39]['file'] = 'legacy_xoopsform_simpleform.html';
$modversion['templates'][39]['description'] = 'The embedded template for the simple form of the xoopsform.';
$modversion['templates'][40]['file'] = 'legacy_xoopsform_tableform.html';
$modversion['templates'][40]['description'] = 'The embedded template for the table form of the xoopsform.';
$modversion['templates'][41]['file'] = 'legacy_xoopsform_themeform.html';
$modversion['templates'][41]['description'] = 'The embedded template for the theme form of the xoopsform.';
$modversion['templates'][42]['file'] = 'legacy_xoopsform_elementtray.html';
$modversion['templates'][42]['description'] = 'The embedded template for the element tray of the xoopsform.';
$modversion['templates'][43]['file'] = 'legacy_xoopsform_textdateselect.html';
$modversion['templates'][43]['description'] = 'The embedded template for the text date select of the xoopsform.';
$modversion['templates'][44]['file'] = 'legacy_xoopsform_dhtmltextarea.html';
$modversion['templates'][44]['description'] = 'The embedded template for the dhtml text area of the xoopsform.';
$modversion['templates'][45]['file'] = 'legacy_xoopsform_opt_smileys.html';
$modversion['templates'][45]['description'] = 'The embedded template for the smiles list of the dhtml text area of the xoopsform.';
$modversion['templates'][46]['file'] = 'legacy_xoopsform_opt_validationjs.html';
$modversion['templates'][46]['description'] = 'The embedded template for the javascriot of the the xoopsform to validation the input value.';
$modversion['templates'][47]['file'] = 'legacy_xoopsform_grouppermform.html';
$modversion['templates'][47]['description'] = 'The embedded template for the groupperm form of the the xoopsform.';
...
$modversion['templates'][52]['description'] = 'Replace top page if not module content selected.';
