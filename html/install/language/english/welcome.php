...
$content =
    ...
    <p>
    The XCL modules are released under the terms of the <a href="https://github.com/xoopscube/xcl/blob/master/docs/GPL_V2.txt" target="_blank" rel="external">GNU General Public License (GPL)</a> and is free to use and modify.
